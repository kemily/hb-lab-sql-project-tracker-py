...
def get_student_by_github(github):
    ...
    #returns a row as a tuple-like object. 
    #This object contains the values for each of the columns we selected.
